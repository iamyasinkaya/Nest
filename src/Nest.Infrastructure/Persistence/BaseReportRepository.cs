...
public class BaseReportRepository<TEntity> : IRepository<TEntity> where TEntity : class
{
    protected readonly ApplicationReportDbContext _context;
    protected readonly DbSet<TEntity> _dbSet;

    public BaseReportRepository(ApplicationReportDbContext context)
    {
        _context = context;
